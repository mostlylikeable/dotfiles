...
# List long, all but '.', '..', mark types, size
alias la="ls -lAFh"
...
###############################################################################
# Walk up the directory tree from $PWD, looking for a file.
#
# @params
#   pattern - name pattern to look for
# @output
...
###############################################################################
# Send files to the trash (timestamped to avoid collisions).
#
# @params
